      ...
      panel.innerHTML = `
        ...
        <div class="jenni-edge-body">
          <div style="display:flex;gap:8px;align-items:center;margin-bottom:8px">
            ...
            <button class="fingerprint-toggle" style="padding:4px 8px;border-radius:6px;border:1px solid #e5e7eb;background:#f8fafc;cursor:pointer;font-size:11px;margin-left:auto">🔍 Hereee</button>
          </div>
